          ...
          GraphQL: {
            client: {
              ...
              graphql: <FALLBACK_TYPES = unknown, TYPED_GQL_STRING extends string = string>(
                ...
                runWithAmplifyServerContext<GraphQLResponseV6<FALLBACK_TYPES, TYPED_GQL_STRING>>(
                  amplifyConfig,
                  libraryOptions,
                  (contextSpec) => gqlServerClient.graphql(contextSpec, options, additionalHeaders),
                ),
            },
          },
        },
